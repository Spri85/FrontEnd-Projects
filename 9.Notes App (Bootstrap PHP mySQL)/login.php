...
//Run query: Check combination of email & password exist
...
//if email & password dont't match print error
...
if($count !==1){
  ...
  if(empty($_POST['rememberme'])){
    ...
    $expiration = date('Y-m-d H:i:s', time() + 1296000); //current date and time + 15 days = 15*24*60*60
